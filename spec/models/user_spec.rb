...
describe User do
  describe '#create' do
    ...
    it "is invalid without a family_name_kana" do
      ...
      user.valid?
      expect(user.errors[:family_name_kana])
    end
    ...
    it "is invalid without a d_family_name" do
      ...
      user.valid?
      expect(user.errors[:d_family_name])
    end
    ...
    it "is invalid without a first_name_kana" do
      ...
      user.valid?
      expect(user.errors[:d_first_name_kana])
    end
